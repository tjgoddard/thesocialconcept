            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <ul className="space-y-4 mb-8">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">Up to $25K monthly ad spend</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">1 primary advertising channel</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
              ...
              >
                ...
                <ul className="space-y-4 mb-8">
                  ...
                  <li className="flex items-start">
                    <Check className="w-5 h-5 text-white mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-white/90">Full-channel marketing (TikTok, Meta)</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="w-5 h-5 text-white mr-3 mt-0.5 flex-shrink-0" />
