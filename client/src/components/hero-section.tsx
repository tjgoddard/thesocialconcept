    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
        ...
        >
          ...
          >We partner with eCommerce companies to deliver full-funnel marketing solutions that combine big ideas, sharp execution, and measurable performance.</motion.p>
